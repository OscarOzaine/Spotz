 ...
 */
package com.spotz.utils.metadata;

import com.spotz.utils.lang.annotations.NotNull;
import com.spotz.utils.lang.annotations.Nullable;

/**
 * Models a particular tag within a {@link com.spotz.utils.metadata.Directory} and provides methods for obtaining its value.
 * Immutable.
 *
...
public class Tag
{
    ...
    /**
     * Get the name of the {@link com.spotz.utils.metadata.Directory} in which the tag exists, such as
     * <code>Exif</code>, <code>GPS</code> or <code>Interoperability</code>.
     *
     * @return name of the {@link com.spotz.utils.metadata.Directory} in which this tag exists
     */
    @NotNull
